...
public class TipaniAttachmentController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<TipaniAttachmentDTO> getEntityById(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<TipaniAttachmentDTO> updateEmployee(@PathVariable Long id, @RequestBody TipaniAttachmentDTO attachmentDTO) throws ResourceNotFoundException {
        TipaniAttachmentDTO dto = service.updateTipaniAttach(id, attachmentDTO);
